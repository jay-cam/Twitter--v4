    ...
    <div className="flex border-b border-gray-200 p-3 space-x-3">
      ...
      <div className="w-full divide-y divide-gray-700">
        ...
        <div className="flex items-center justify-between pt-2.5">
          <div className="flex">
            <HiOutlinePhoto className="h-10 w-10 hoverEffect p-2 text-sky-500 hover:bg-sky-100" />
            <HiOutlineFaceSmile className="h-10 w-10 hoverEffect p-2 text-sky-500 hover:bg-sky-100" />
          </div>
